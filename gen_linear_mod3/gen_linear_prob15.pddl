(define (problem run-generator2)
    ...
    (:objects gen - generator tank1 tank2 tank3 tank4 tank5 tank6 tank7 tank8 tank9 tank10 tank11 tank12 tank13 tank14 tank15 - tank)
    (:init
		(= (fuelLevel gen)  900)
		(= (capacity gen)  1000)
		(on gen)
		...
		(at 800.0 (available tank14))
		(at 801.0 (not (available tank14)))
    )  
	(:goal (generator-ran))
)